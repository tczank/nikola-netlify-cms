...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.facebook.com/forabozonihon', 'Fora Bolsonaro Japão', 'fas fa-globe-asia'),
        ('https://www.facebook.com/UNIDXSporUmBrasilmelhor', 'UNIDXS por um Brasil Melhor', 'fas fa-globe-europe'),
