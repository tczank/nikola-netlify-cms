...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.facebook.com/forabozonihon', 'Fora Bolsonaro Japão', 'far fa-globe-asia'),
        ('https://www.facebook.com/UNIDXSporUmBrasilmelhor', 'UNIDXS por um Brasil Melhor', 'far fa-globe-europe'),
