...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.facebook.com/forabozonihon', 'Fora Bolsonaro Japão', 'fab fa-globe-asia'),
        ('https://www.facebook.com/UNIDXSporUmBrasilmelhor', 'UNIDXS por um Brasil Melhor', 'fab fa-globe-europe'),
